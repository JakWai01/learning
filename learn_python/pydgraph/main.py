...
def create_client_stub():
    return pydgraph.DgraphClientStub('127.0.0.1:8000')
...
def create_data(client):
    ...
    try:
        ...
        # Clean up. Calling this after txn.comit() is a no-op and hence safe.
        txn.discard()
...
# Query to check for delete node
def query_bob(client):
    ...
    variables = {'$b': 'Bob'}
    res = client.txt(read_only=True).query(query, variables=variables)
    ppl = json.loads(res.json)
